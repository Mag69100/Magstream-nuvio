...
var require_doodstream = __commonJS({
  "src/extractors/doodstream.js"(exports2, module2) {
    ...
    function extractDood2(playerUrl) {
    ...
    module2.exports = { canHandle, extract: extractDood2 };
  }
});
...
var require_streamtape = __commonJS({
  "src/extractors/streamtape.js"(exports2, module2) {
    ...
    function extractStreamtape2(playerUrl) {
    ...
    module2.exports = { canHandle, extract: extractStreamtape2 };
  }
});
...
var require_sendvid = __commonJS({
  "src/extractors/sendvid.js"(exports2, module2) {
    ...
    function extractSendvid2(playerUrl) {
    ...
    module2.exports = { canHandle, extract: extractSendvid2 };
  }
});
...
var require_sibnet = __commonJS({
  "src/extractors/sibnet.js"(exports2, module2) {
    ...
    function extractSibnet2(playerUrl) {
      return fetch(playerUrl, {
        headers: {
          "User-Agent": UA,
    ...
    module2.exports = { canHandle, extract: extractSibnet2 };
  }
});
...
var require_vidmoly = __commonJS({
  "src/extractors/vidmoly.js"(exports2, module2) {
    ...
    function extractVidmoly2(playerUrl) {
    ...
    module2.exports = { canHandle, extract: extractVidmoly2 };
  }
});
...
var require_filemoon = __commonJS({
  "src/extractors/filemoon.js"(exports2, module2) {
    ...
    function extractFilemoon2(playerUrl) {
    ...
    module2.exports = { canHandle, extract: extractFilemoon2 };
  }
});
...
var require_streamwish = __commonJS({
  "src/extractors/streamwish.js"(exports2, module2) {
    ...
    function extractStreamwish2(playerUrl) {
      var embedUrl = playerUrl.includes("/e/") ? playerUrl : playerUrl.replace(/\/(v|f)\//, "/e/");
      return fetch(embedUrl, {
        headers: {
          "User-Agent": UA,
    ...
    module2.exports = { canHandle, extract: extractStreamwish2 };
  }
});
...
var require_voe = __commonJS({
  "src/extractors/voe.js"(exports2, module2) {
    ...
    function extractVoe2(playerUrl) {
      return fetch(playerUrl, {
    ...
    module2.exports = { canHandle, extract: extractVoe2 };
  }
});
...
var require_frembed = __commonJS({
  "src/extractors/frembed.js"(exports2, module2) {
    ...
    function extractFrembed2(playerUrl) {
    ...
    module2.exports = { canHandle, extract: extractFrembed2 };
  }
});
...
var require_generic = __commonJS({
  "src/extractors/generic.js"(exports2, module2) {
    ...
    function extractGeneric2(playerUrl) {
      var origin = "";
      try {
    ...
    module2.exports = { canHandle, extract: extractGeneric2 };
  }
});
